...
data class BookmarkedResumeResponseDto(
    val id: String,
    val title: String,
    ...
    companion object {
        fun of(resume: Resume, profileImageDownloadUrl: String?): BookmarkedResumeResponseDto {
            return BookmarkedResumeResponseDto(
                id = resume.id!!,
                title = resume.title,
